...
- `tests/` includes conformance coverage for grammar-controlled transitions, schema validation, CLI diagnostics, tracing and debug levels, stdin/file input, REPL behavior, and literal escape behavior.
